...
import com.obd.pires.commands.protocol.DescribeProtocolNumberCommand;
...
public class DescribeProtocolNumberCommandTest {
    ...
    public void testGetCalculatedResult() throws Exception {
        ...
        Assert.assertEquals(command.getCalculatedResult(), ObdProtocols.ISO_9141_2.name());//AUTO ISO_9141_2
    ...
    public void testGetProtocol() throws Exception {
        ...
        // call the method to test
        command.readResult(mockIn);
        Assert.assertEquals(command.getObdProtocol(), ObdProtocols.ISO_15765_4_CAN);//AUTO ISO_15765_4_CAN

        // call the method to test
        command.readResult(mockIn);
        Assert.assertEquals(command.getObdProtocol(), ObdProtocols.ISO_15765_4_CAN_B);//ISO_15765_4_CAN_B
