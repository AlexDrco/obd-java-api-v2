...
public class TimeSinceDtcCResponse extends OBDResponse {

    public TimeSinceDtcCResponse() {
        super("01 4E");
    }

    @Override
    public String getDefaultResponse() {
        return "41 4E FF FF"; // Default response with maximum value
    }
